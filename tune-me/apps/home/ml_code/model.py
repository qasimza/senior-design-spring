...
tracks = pd.read_csv(r'C:\Users\Zaina\OneDrive - University of Cincinnati\Spring 2023\TuneMeFinalAttempt\tuneMe\tuneMe\apps\home\ml_code\tracks.csv')
tracks.head()
...
import pickle
with open(r'C:\Users\Zaina\OneDrive - University of Cincinnati\Spring 2023\TuneMeFinalAttempt\tuneMe\tuneMe\apps\home\ml_code\model.pkl', 'wb') as file:
...
"""Here we will define a similarity function which will define the similarities between the input song and all other songs from the dataset, 
    it takes genres to do so, we can also use different field like danceability or acousticness to compute the similarness."""
